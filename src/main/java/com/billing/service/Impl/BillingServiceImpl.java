...
public class BillingServiceImpl implements BillingService {
    ...
    public Invoice saveInvoice(Invoice invoice) {
        ...
        for (InvoiceItem item : invoice.getItems()) {
            ...
            double taxableAmount = baseAmount - discountAmount;
            double taxAmount = taxableAmount * (tax / 100);
        ...
        double advance = invoice.getAdvanceAmount() != null ? invoice.getAdvanceAmount() : 0.0;
        invoice.setBalanceAmount(totalAmount - advance);
    ...
    public Invoice updateInvoice(Long id, Invoice invoice) {
        ...
        double advance = invoice.getAdvanceAmount() != null ? invoice.getAdvanceAmount() : 0.0;
        existing.setBalanceAmount(totalAmount - advance);
